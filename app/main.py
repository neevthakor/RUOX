...
def main():
    ...
    while True:
        try:
            ...
            # The agent loop will print text. 
            # We need to capture the last assistant message and read it via TTS if in voice mode.
            # But the agent.run_task handles multiple tool calls. 
            # We'll just read whatever was added by the assistant after the task finishes running.
